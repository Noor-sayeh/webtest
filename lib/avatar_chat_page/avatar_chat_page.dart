...
class _AvatarChatPageState extends State<AvatarChatPage> {
  ...
  void _sendMessage() {
    ...
    Future.delayed(const Duration(seconds: 1), () {
      _addAvatarMessage(_generateAvatarResponse());
    });
  }

  String _generateAvatarResponse() {
    final responses = [
      "I'd be happy to help you find the perfect gift!",
      "That's interesting! What kind of gift are you looking for?",
      "I can suggest some great options based on your preferences.",
      "Let me check my recommendations for you...",
      "Would you like me to suggest some trending gift ideas?",
    ];
